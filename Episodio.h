...
public: 
	...
	Episodio(); 
	// Con parámetros
	Episodio(int ID, string nombre, string genero, int duracion, int calificacion, string serie, string numEpisodio, string numTemporada);
...
Episodio::Episodio(int ID, string nombre, string genero, int duracion, int calificacion, string serie, string numEpisodio, string numTemporada) : Video(ID, nombre, genero, duracion, calificacion){
...
string Episodio::getNumTemporada(){
