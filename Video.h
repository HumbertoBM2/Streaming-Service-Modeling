...
public:
	...
	// Constructores
	Video();              // Default
	Video(int ID, string nombre, string genero, int duracion, int calificacion);  // Con parámetros 
...
Video::Video(int ID, string nombre, string genero, int duracion, int calificacion){
